...
namespace MonitorVendas.Api.Data.Migrations
{
    ...
    [Migration("20260804125615_WarmupPauseAndComplete")]
    partial class WarmupPauseAndComplete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MonitorVendas.Api.Features.Numbers.WhatsappNumber", b =>
                {
                    ...
                    b.Property<DateTime?>("WarmupCompletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("WarmupPausedAt")
                        .HasColumnType("timestamp with time zone");
